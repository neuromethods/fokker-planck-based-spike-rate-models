...
# toggle for HEUN integration method
@njit
...
def run_spec2m_simple_HEUN(ext_signal, params, filename_h5,
                      rec_vars = ['wm'], rec = False, FS = False):
    ...
    results = sim_spec2m_simple_HEUN(mu_ext,sigma_ext,steps,dt,Ew,a,b,C,tauw,map_Vmean,
                                map_r,mu_tab,sig_tab,lambda_1,
                                lambda_2_mattia,rec,K,J,delay_type,n_d,
                                taud, r0, s0, w0, uni_int_order)
    #store results in dictionary which is returned
