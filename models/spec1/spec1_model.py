...
#################################################################
# old model version without heun integration
@njit
...
def run_spec1_without_HEUN_OLD(ext_signal, params, filename_h5,
              rec_vars = ['wm'], rec = False, FS = False):
    ...
    # run simulation loop
    results = sim_spec1_without_HEUN_OLD(mu_ext, sigma_ext,map_Vmean,map_r,mu_tab,sig_tab,
                        lambda_1,tauw, dt, steps,C, a,b,Ew, s0, r0,w0,
